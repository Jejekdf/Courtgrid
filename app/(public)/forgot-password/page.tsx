...
export const metadata: Metadata = {
  title: "Lupa Password | CourtGrid",
  description: "Reset password akun CourtGrid Anda.",
};
  ...
  return (
    <main className="min-h-screen w-full flex bg-white text-zinc-950 font-sans selection:bg-zinc-950 selection:text-white">
      ...
      <div className="hidden lg:flex w-1/2 bg-zinc-950 relative overflow-hidden flex-col justify-between p-12 lg:p-24 border-l border-zinc-800">
        <div className="absolute inset-0 bg-[url('/futsal1.png')] bg-cover bg-center opacity-30 mix-blend-luminosity transition-transform duration-1000 hover-fine:scale-105" />
        ...
        <div className="relative z-10 flex flex-col justify-end h-full max-w-xl">
          ...
          <blockquote className="space-y-6">
            <p className="text-2xl lg:text-3xl font-medium leading-tight text-white">
              &ldquo;Kami memastikan akun dan jadwal tim Anda selalu aman, bahkan saat Anda tidak bisa mengaksesnya sesaat.&rdquo;
            </p>
            <footer className="flex items-center gap-4">
              ...
              <div>
                <div className="font-semibold text-white">Tim Support CourtGrid</div>
                <div className="text-sm text-zinc-300">Selalu Siap Membantu</div>
              </div>
            </footer>
          </blockquote>
        </div>
