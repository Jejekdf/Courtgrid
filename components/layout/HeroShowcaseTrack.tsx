    ...
    <div className="mt-8 sm:mt-10 w-full relative group/carousel">
      ...
      <div className="hidden sm:flex items-center justify-end gap-2 mb-3">
        <button
          ...
          className="size-9 rounded-xl border border-zinc-200/90 bg-white hover:bg-zinc-100 disabled:opacity-30 disabled:pointer-events-none flex items-center justify-center text-zinc-800 transition-colors shadow-2xs cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500"
        >
      ...
      <div
        ...
        className="flex gap-3.5 sm:gap-5 overflow-x-auto pb-3 scrollbar-none snap-x snap-mandatory -mx-4 px-4 sm:mx-0 sm:px-0 scroll-smooth"
      >
        {images.map((img, idx) => (
          <Link
            key={idx}
