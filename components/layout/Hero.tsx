      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 lg:pt-10 pb-12 sm:pb-16 lg:pb-20 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3.5 w-full sm:w-auto">
          <Link href="/dashboard/book" className="w-full sm:w-auto">
            <Button
              size="lg"
              className="w-full sm:w-auto text-sm sm:text-base font-bold min-h-12 sm:min-h-13 h-12 sm:h-13 px-7 sm:px-8 bg-zinc-950 hover:bg-zinc-800 active:scale-[0.98] text-white rounded-xl shadow-sm transition-all duration-150 cursor-pointer group"
            >
          ...
          <Link href="/courts" className="w-full sm:w-auto">
            <Button
              variant="secondary"
              size="lg"
              className="w-full sm:w-auto text-sm sm:text-base font-bold min-h-12 sm:min-h-13 h-12 sm:h-13 px-6 sm:px-8 bg-white border border-zinc-200/90 text-zinc-900 hover:bg-zinc-50 active:scale-[0.98] rounded-xl transition-all duration-150 cursor-pointer shadow-2xs"
            >
