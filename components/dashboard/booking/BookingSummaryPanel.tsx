    ...
    <div className="bg-white border border-zinc-200/80 rounded-2xl p-6 shadow-xs space-y-6 sticky top-6">
      <div className="flex items-center justify-between border-b border-zinc-100 pb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-extrabold text-base text-zinc-950">{t("summaryTitle")}</h3>
        </div>
        <span className="text-[0.6875rem] font-mono font-bold bg-zinc-100 text-zinc-600 px-2 py-0.5 rounded-md">
          {t("stripeBadge")}
        </span>
      </div>
      ...
      {activeCourt && selectedTimeSlots.length > 0 ? (
        <div className="space-y-5">
          <div className="space-y-2.5 text-sm">
            ...
            <div className="flex justify-between py-1.5 border-b border-zinc-100">
              <span className="text-zinc-500 font-mono">{t("durationLabel")}</span>
              <span className="font-bold text-zinc-950 font-mono">
                {t("durationValue", { count: selectedTimeSlots.length })}
              </span>
            </div>
            <div className="flex justify-between py-1.5 border-b border-zinc-100">
              <span className="text-zinc-500 font-mono">{t("totalLabel")}</span>
