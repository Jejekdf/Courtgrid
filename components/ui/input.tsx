      ...
      <div className={cn("space-y-1.5 w-full text-left", containerClassName)}>
        ...
        <div className="relative flex items-center w-full">
          ...
          <input
            ...
            disabled={disabled}
            className={cn(
              "flex h-11 sm:h-10 w-full rounded-lg border bg-zinc-50 px-3.5 py-2 text-base sm:text-sm text-zinc-950 placeholder:text-zinc-400 focus:outline-hidden focus:ring-2 focus:ring-zinc-950/20 focus:border-zinc-950 disabled:cursor-not-allowed disabled:opacity-50 transition-colors duration-200",
              leftIcon && "pl-10",
              rightElement && "pr-10",
              error
