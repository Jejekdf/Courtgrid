                      ...
                      (r: SearchResultReservation) => (
                        ...
                        >
                          <div>
                            ...
                            <div className="text-[0.6875rem] text-zinc-400 font-mono">
                  ...
                  <div className="space-y-1.5 pt-1 border-t border-zinc-100">
                    ...
                    {searchResults.courts.map((c: SearchResultCourt) => (
                      ...
                      >
                        ...
                        <span className="text-[0.6875rem] font-mono font-bold text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-200">
